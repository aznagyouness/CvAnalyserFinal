...
from src.vectordb.enums.VectorDBEnums import (DistanceMethodEnums, PgVectorTableSchemeEnums, 
...
class PGVectorProvider(VectorDBInterface):
    ...
    async def search_by_vector(self, collection_name: str, vector: list, limit: int) -> List[RetrievedDocumentEnum]:
